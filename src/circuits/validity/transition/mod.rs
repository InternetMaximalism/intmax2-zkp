...
use super::{
    block_validation::main_validation::{MainValidationCircuit, MainValidationPublicInputs},
...
> {
    ...
    pub new_pis: ValidityPublicInputs,
    pub main_validation_proof: ProofWithPublicInputs<F, C, D>,
...
{
    pub fn new(
        main_validation_circuit: &MainValidationCircuit<F, C, D>,
        ...
        main_validation_circuit
            ...
            .expect("Main validation proof is invalid");
        let main_validation_pis = MainValidationPublicInputs::from_u64_vec(
        ...
        assert_eq!(main_validation_pis.prev_block_hash, prev_pis.block_hash);
        ...
        let mut new_account_tree_root = main_validation_pis.account_tree_root.clone();
        // account registoration
        let is_account_registoration = prev_pis.is_registoration_block && prev_pis.is_valid_block;
        ...
        assert_eq!(new_account_tree_root, main_validation_pis.account_tree_root);
...
impl<const D: usize> ValidityTransitionTarget<D> {
        ...
        C::Hasher: AlgebraicHasher<F>,
    {
        ...
        let main_validation_proof = main_validation_circuit.add_proof_target_and_verify(builder);
        ...
        <C as GenericConfig<D>>::Hasher: AlgebraicHasher<F>,
    {
        ...
        witness
            .set_proof_with_pis_target(&self.main_validation_proof, &value.main_validation_proof);
